...
{: .note }
> Email [digitalinitiatives@library.utoronto.ca](mailto:digitalinitiatives@library.utoronto.ca) to request a login account to edit your Collections U of T Basic Pages in the Omeka /explore/ instance or if you want to modify your /explore/ Exhibit or add a new Exhibit for a collection. You login will enable you to edit and create Exhibits but not delete any Exhibit that is not your own. You can delete pages in your own Exhibits so be careful not to accidentally delete a page. 
